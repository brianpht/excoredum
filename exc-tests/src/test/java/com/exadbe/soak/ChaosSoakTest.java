 ...
 * {@code -Dexc.soak.warmupRounds} / {@code -Dexc.soak.steadyRounds}.
 */
@Tag("soak")
class ChaosSoakTest {
    ...
    private static final int WARMUP_ROUNDS = Integer.getInteger("exc.soak.warmupRounds", 15_000);
    private static final int STEADY_ROUNDS = Integer.getInteger("exc.soak.steadyRounds", 120_000);
