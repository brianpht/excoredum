package io.justrade.gateway;

import io.justrade.gateway.config.GatewayConfig;
import io.justrade.gateway.http.HttpServer;
import io.justrade.gateway.http.Router;
import io.justrade.gateway.read.ReadPump;
import io.justrade.gateway.stream.MarketPump;
 ...
 *
 * <p>Run with {@code ./gradlew :gateway:run --args="--config=..."}.
 */
public final class GatewayLauncher {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("gateway listening on " + config.httpHost() + ":" + config.httpPort());
            Runtime.getRuntime()
